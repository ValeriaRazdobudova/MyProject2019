...
namespace NTCService.Controllers
{
    ...
    public class ApplicationsController : Controller
    {
        ...
        {
            return View(await db.Application.ToListAsync());
        }
        ...
        public async Task<ActionResult> Create([Bind(Include = "id_application,phone_number_NTCworker,email_NTCworker")] Application application)
        {
